        ...
        <div className={styles.root}>
            <div className={styles.container}>
                <Paper className={styles.description}>
                    ...
                    {import.meta.env.VITE_ACTIVATOR_CHALLENGE && (
                        <>
                            <Divider />
                            <div className={styles.taskContainer}>
                                ...
                                <ol>
                                    ...
                                    <li>
                                        Сделать так, чтобы надпись <span className={styles.highlight}>«Условия выполнены»</span>{" "}
                                        отображалась когда все добавленные условия истинны. Надпись{" "}
                                        <span className={styles.highlight}>«Условия не выполнены»</span> должна отображаться если хотя бы
                                        одно условие ложное
                                    </li>
                                    <li>
                                        Реализовать логику для формулы активации. В инпут вводится формула типа{" "}
                                        <span className={styles.highlight}>#1 AND #2</span>, которая говорит о том, что активатор сработает
                                        если условия <span className={styles.highlight}>#1</span> и{" "}
                                        <span className={styles.highlight}>#2</span> истинны
                                    </li>
                ...
                <div className={styles.task}>
                    <DataTable />
                    {import.meta.env.VITE_ACTIVATOR_CHALLENGE && <Activator />}
                </div>
            </div>
        </div>
    );
